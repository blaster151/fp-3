...
> **Note:** The deprecated `scripts/organize-allts.mjs` helper has been removed; follow the manual process outlined below.
...
2. Analyze current structure by reviewing `allTS.ts` and confirming the marker comments listed above.
