...
- Pass 4 residual semantics: default residual θ components now lift base θ evaluations into residual carriers via `ResidualFunctorSummary.lift`, automatically synthesise per-object carriers, and expose optional alignment witnesses through the new monad-map translators.
