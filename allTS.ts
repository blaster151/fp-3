...
export * from "./src/all/semiring-matrix"
...
export * from "./category/slice-constructors"
export * from "./category/category-diagnostics"
export * from "./category/category-properties"
export * from "./models"
export * from "./kinds/group-structures"
