...
describe("affine scheme morphism utilities", () => {
  const ringSamples = [-6n, -4n, -3n, -2n, -1n, 0n, 1n, 2n, 3n, 4n, 5n, 6n]

  const spectrumZ: PrimeSpectrum<bigint> = {
    ring: RingInteger,
    label: "Spec ℤ",
    points: [
      { ideal: principalIdeal(RingInteger, 0n, "(0)"), label: "(0)", samples: ringSamples },
      { ideal: principalIdeal(RingInteger, 2n, "(2)"), label: "(2)", samples: ringSamples },
    ],
  }
